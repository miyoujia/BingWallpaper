...
public class App {
    ...
    public String getThePath(String str) throws JsonSyntaxException, IOException {
		...
		name=subObject.get("enddate").getAsString();
		// getting the path of the bing jpg picture via analysis xml
		String path = "http://www.bing.com/" + relativePath;
		return path;
	}
	public String downLoadWallpaper(String path) throws IOException {
		// download the jpg file
		URL url = new URL(path);
		DataInputStream dis = new DataInputStream(url.openStream());
		String f="D:\\Wallpaper\\"+name+".jpg";
	...
	public void settingWallpaper(String path) {
